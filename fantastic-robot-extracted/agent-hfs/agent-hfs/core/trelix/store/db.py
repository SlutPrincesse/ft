...
if TYPE_CHECKING:
    from ..indexing.multi_granularity import SubSymbolChunk
    from ..store.read_pool import ReadOnlyConnectionPool
...
if TYPE_CHECKING:
    from ..analysis.defuse import DefUseEdge
    from ..analysis.taint import TaintFlow
...
class Database:
    ...
    def get_sub_chunks_for_symbol(
        ...
        from ..indexing.multi_granularity import Granularity, SubSymbolChunk
