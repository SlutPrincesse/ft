...
from ..graph.community import assign_communities, detect_communities, get_community_summary
from ..graph.concepts import ConceptExtractor, save_concepts
from ..graph.persistence import save_graph_metadata
...
class GraphBuilder:
    ...
    def build(self, extract_concepts: bool = False) -> GraphBuildResult:
        ...
        from ..graph.community import compute_pagerank
