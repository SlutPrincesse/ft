...
local_BROWSER_RECOVERY_HELP = (
    "To use Agent Zero's internal local browser instead, open Browser settings and "
    "set Browser location to Internal local browser, or run `/browser container` "
    "from A0 CLI."
)
