...
across all terminal backends (local, local, ssh, singularity, modal, daytona, vercel_sandbox).
...
class ShellFileOperations(FileOperations):
    ...
    This includes local, local, singularity, ssh, modal, and daytona environments.
    """
    ...
    def __init__(self, terminal_env, cwd: str = None):
        ...
        # path which doesn't exist inside container/cloud backends (modal, local).
    ...
    def delete_path(self, path: str, recursive: bool = False) -> WriteResult:
        ...
        every backend (local / local / ssh / Windows).
        """
    ...
    def _python_delete(self, path: str, recursive: bool) -> WriteResult:
        ...
        snippet = (
            ...
            # Python 3.8 and the remote interpreter (local/ssh) may still
    ...
    def _lsp_local_only(self) -> bool:
        ...
        files they're linting.  Remote/sandboxed backends (local,
    ...
    def _snapshot_lsp_baseline(self, path: str) -> None:
        ...
        Skipped entirely on non-local backends (local, Modal, SSH,
