...
Usage::
    ...
    from ..core.config import EmbedderConfig, RetrievalConfig
...
if TYPE_CHECKING:
    from ..core.config import EmbedderConfig, RetrievalConfig
    from ..core.models import RetrievedContext, SearchResult
...
class GraphRAGSynthesizer:
    ...
    def __init__(self, embedder_config: EmbedderConfig, retrieval_config: RetrievalConfig) -> None:
        ...
        from ..llm.client import TrelixChatClient as _TC
