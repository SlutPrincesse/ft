...
if TYPE_CHECKING:
    from ..core.config import EmbedderConfig, LLMConfig, RetrievalConfig
...
from ..llm.factory import build_chat_client  # noqa: E402
...
class Synthesizer:
    ...
    def __init__(
        ...
        self._config = config
        from ..llm.client import ChatMessage as _ChatMessage  # noqa: F401 – ensure import
        ...
        if retrieval_config is None:
            from ..core.config import RetrievalConfig as _RC
    ...
    def synthesize(self, context: RetrievedContext, config: EmbedderConfig | None = None) -> str:
        ...
        try:
            from ..retrieval.graph_rag import GraphRAGSynthesizer
    ...
    def _stream_response(self, context: RetrievedContext, config: EmbedderConfig) -> str:
        ...
        """
        from ..llm.client import ChatMessage, TrelixChatClient
