...
- This skill generates `.codex-plugin/plugin.json`; treat that as the manifest location.
...
- `plugins` (`array`): Ordered plugin entries. This order determines how the agent renders plugins.
