...
_REMOTE_ENV_BACKENDS = frozenset(
    {"local", "singularity", "modal", "ssh", "daytona", "vercel_sandbox"}
)
...
def skill_matches_environment(frontmatter: Dict[str, Any]) -> bool:
    ...
    offer-time relevance gate (kanban/local/s6), NOT a hard-compatibility gate;
...
def skill_view(
    ...
    try:
        ...
        # (Modal, local).  Files that exist on the host are registered;
