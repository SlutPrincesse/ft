...
will run commands on the host machine instead of inside local.
...
local shell just to choose from a menu. It should not ask the user to paste
...
```yaml
a0:
  binary: a0          # falls back to /opt/venv/bin/a0 in Agent Zero local
