...
- For CLI login flows, show provider/menu choices in chat and send the user's selected option back to the active shell session. Do not send users to a local shell only to choose a menu.
