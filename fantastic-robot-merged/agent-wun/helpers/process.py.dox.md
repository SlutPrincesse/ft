...
- Important called helpers/classes observed in the source: `stop_server`, `runtime.is_local`, `PrintStyle.standard`, `os.execv`, `sys.exit`, `_server.shutdown`, `exit_process`, `restart_process`.
...
- Related tests observed by source search:
  ...
  - `tests/test_local_release_plan.py`
