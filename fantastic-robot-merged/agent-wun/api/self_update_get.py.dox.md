...
- Important called helpers/classes observed in the source: `self_update.get_update_info`, `runtime.is_local`, `self_update.load_pending_update`, `self_update.load_last_status`.
