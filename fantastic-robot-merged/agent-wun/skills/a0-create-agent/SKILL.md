...
| `agent.system.main.environment.md` | A different runtime/environment description than the default Kali/local Agent Zero environment. |
...
| `agent.system.main.environment.md` | Describe a non-default runtime environment | `/a0/agents/hacker/prompts/agent.system.main.environment.md` (Kali/local) |
